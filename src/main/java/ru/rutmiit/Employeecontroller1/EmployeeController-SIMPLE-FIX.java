...
public class EmployeeController {
    ...
    public String transferEmployee(
        ...
        // ИСПРАВЛЕНИЕ: Используем path variable вместо конкатенации
        // Spring автоматически подставит значение из @PathVariable и закодирует URL
        return "redirect:/employees/employee-details/{employee-full-name}";
    }
}
